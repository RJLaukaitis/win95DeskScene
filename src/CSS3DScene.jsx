...
extend({ CSS3DRenderer, EffectComposer, RenderPass, ShaderPass });
...
const CSS3DScene = () => {
  ...
  useEffect(() => {
    ...
    // Setup the EffectComposer for post-processing
    composer.current = new EffectComposer(renderer);
    composer.current.addPass(new RenderPass(scene, camera));
    const filmGrainPass = new ShaderPass(filmGrainShader);
    composer.current.addPass(filmGrainPass);

    // Set the size of the composer
    ...
    crtmesh.position.set(0.8, 3.13, 0.35);
    ...
    vhsmesh.position.set(0.8, 3.13, 0.33);
    ...
    dimMesh.position.set(0.8, 3.13, 0.32);
    ...
    const renderLoop = () => {
      ...
      filmGrainShader.uniforms.time.value += 0.01;
